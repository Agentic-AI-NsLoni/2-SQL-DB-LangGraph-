...
# installed.
TCL_PREFIX='F:/AI Egineer/Agentic-AI/2-SQL-DB-LangGraph-/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='F:/AI Egineer/Agentic-AI/2-SQL-DB-LangGraph-/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='F:/AI Egineer/Agentic-AI/2-SQL-DB-LangGraph-/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IF:/AI Egineer/Agentic-AI/2-SQL-DB-LangGraph-/venv\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LF:/AI Egineer/Agentic-AI/2-SQL-DB-LangGraph-/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='F:/AI Egineer/Agentic-AI/2-SQL-DB-LangGraph-/venv\Library\lib\tclstub86.lib'
